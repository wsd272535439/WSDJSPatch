...
var ImagePicker = function (_React$Component) {
    ...
    ImagePicker.prototype.render = function render() {
        ...
        return _react2["default"].createElement(_reactNative.View, { style: styles.container }, files.map(function (item, index) {
            return _react2["default"].createElement(_reactNative.View, { key: index, style: [styles.item, styles.size] }, _react2["default"].createElement(_reactNative.Image, { source: { uri: item.url }, style: [styles.size, styles.image] }), _react2["default"].createElement(_reactNative.TouchableWithoutFeedback, { onPress: function onPress() {
                    return _this2.removeImage(index);
                } }, _react2["default"].createElement(_reactNative.View, { style: styles.closeWrap }, _react2["default"].createElement(_reactNative.Text, { style: styles.closeText }, "×"))));
        }), _react2["default"].createElement(_reactNative.TouchableWithoutFeedback, { onPress: this.showPicker, onPressIn: this.onPressIn, onPressOut: this.onPressOut }, _react2["default"].createElement(_reactNative.View, { ref: function ref(conponent) {
                return _this2.plusWrap = conponent;
            }, style: [styles.item, styles.size, styles.plusWrap, styles.plusWrapNormal] }, _react2["default"].createElement(_reactNative.Text, { style: [styles.plusNormal, styles.plusText] }, "+"))), this.state.visible ? _react2["default"].createElement(_ImageRoll2["default"], { onCancel: this.hideImageRoll, onSelected: function onSelected(imgObj) {
