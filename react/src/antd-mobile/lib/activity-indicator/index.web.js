...
var ActivityIndicator = function (_React$Component) {
    ...
    ActivityIndicator.prototype.render = function render() {
        ...
        if (animating) {
            if (toast) {
                return _react2["default"].createElement("div", { className: wrapClass }, _react2["default"].createElement("div", { className: prefixCls + '-content' }, _react2["default"].createElement("span", { className: spinnerClass }), text && _react2["default"].createElement("span", { className: prefixCls + '-toast' }, text)));
            } else {
                return _react2["default"].createElement("div", { className: wrapClass }, _react2["default"].createElement("span", { className: spinnerClass }), text && _react2["default"].createElement("span", { className: prefixCls + '-tip' }, text));
            }
        } else {
            return null;
        }
